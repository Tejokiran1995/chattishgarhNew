...
import static com.visiontek.chhattisgarhpds.Activities.RationDetailsActivity.MESSAGE_FROM_SERIAL_PORT;
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                //TODO Temp Comment
                System.out.println("DEV ID =" + deviceVID);
                System.out.println("P ID =" + devicePID);

                if (deviceVID == 0x10C4 && devicePID == 0xEA60) {
