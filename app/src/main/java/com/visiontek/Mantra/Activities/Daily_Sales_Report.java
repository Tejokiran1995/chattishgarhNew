...
public class Daily_Sales_Report extends AppCompatActivity implements PrinterCallBack {
   ...
   fpsURLInfo fpsURLInfo=new fpsURLInfo();
    ...
    private Daily_Sales_Report mActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = Daily_Sales_Report.this;
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!d.equals("dd/MM/yyyy") && d.length()>0) {
            ...
            public void onClick(View v) {
                ...
                if (flag_print == 1) {
                    ...
                    for (int i = 0; i < comm.size(); i++) {
                        app = comm.get(i) + "          " + scheme.get(i) + "         " + sale.get(i) + "\n";
                        add.append(app);
                    ...
                    str1 = context.getResources().getString(R.string.DAY_REPORT);
                     ...
                     str2=context.getResources().getString(R.string.Date)+" : " + date +"\n"+ context.getResources().getString(R.string.Time)+" :" + time + "\n"
                            +context.getResources().getString(R.string.Day_Report_Date)+" : " + d + "\n"
                            +context.getResources().getString(R.string.FPS_ID)+" : "+ stateBean.getstatefpsId() + "\n";
        ...
        edittext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Daily_Sales_Report.this, date, myCalendar
    ...
    private void hitURL(String xmlformat) {
        ...
        XML_Parsing request = new XML_Parsing(context, xmlformat, 5);
        request.setOnResultListener(new XML_Parsing.OnResultListener() {
            ...
            public void onCompleted(String isError, String msg, String ref, String flow) {
                ...
                if (!isError.equals("00")) {
                    ...
                    comm = databaseHelper.get_DSD(0);
                    qunty = databaseHelper.get_DSD(1);
                    scheme = databaseHelper.get_DSD(2);
                    sale = databaseHelper.get_DSD(3);

                    data = new ArrayList<>();
                    for (int i = 0; i < comm.size(); i++) {
                        String sch = scheme.get(i).trim();
                        switch (sch) {

                            case "AAY":
                                data.add(new DataModel3(comm.get(i), qunty.get(i), "0.0", "0.0", sale.get(i)));
                                break;
                            case "SFY":
                                data.add(new DataModel3(comm.get(i), "0.0", qunty.get(i), "0.0", sale.get(i)));
                                break;
                            case "PHH":
                                data.add(new DataModel3(comm.get(i), "0.0", "0.0", qunty.get(i), sale.get(i)));
                                break;
                        }
