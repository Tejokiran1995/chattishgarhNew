...
public class Aadhaar_Services extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent uid = new Intent(context, Aadhaar_Seeding.class);
                startActivity(uid);
            }
        });
        ...
        beneficiary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ben = new Intent(context, Beneficiary_Verification.class);
                startActivity(ben);
            }
        });
