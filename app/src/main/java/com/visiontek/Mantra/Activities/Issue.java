...
import static com.visiontek.Mantra.Utils.Util.IRISRDservice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent cash = new Intent(Issue.this, Cash_PDS.class);
        ...
        cashless.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Util.toast(Issue.this, "Cashless PDS function is Not Available");
            }
        });
        impds.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Util.toast(Issue.this, "IMPDS function is Not Available");
            }
        });
